...
interface CanvasSectionProps {
  onCanvasChange: (json: { elements: Record<string, CanvasElement>; rootIds: string[] }) => void;
}
...
const CanvasSection = ({ onCanvasChange }: CanvasSectionProps) => {
  ...
  const handleHover = useCallback((id: string | null) => {
    // Could update hovered state here
  }, []);
      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Use the Figma-like editor to create your UI wireframe. Add frames, text, buttons, inputs, and shapes.
          </p>
        </motion.div>
                ...
                {isEmpty && (
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div className="text-center p-6">
                      ...
                      <p className="text-foreground font-medium mb-1">Create your wireframe</p>
                      <p className="text-muted-foreground text-sm max-w-xs">
                        Select a tool from the toolbar and click/drag on the canvas to add elements
                      </p>
                    </div>
                  </div>
                )}
